...
func init() {
	...
	shellExecuteEx = libshell32.NewProc("ShellExecuteExW")
...
func ShellExecuteEx(pExecInfo *SHELLEXECUTEINFO) bool {
	ret, _, _ := syscall.Syscall(shellExecuteEx.Addr(), 1,
		uintptr(unsafe.Pointer(pExecInfo)),
		0,
		0)
